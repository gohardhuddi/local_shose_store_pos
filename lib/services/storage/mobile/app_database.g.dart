...
class _$AppDatabase extends AppDatabase {
  ...
  Future<sqflite.Database> open(
    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        ...
        await database.execute(
          'CREATE INDEX `index_sales_date_time` ON `pos` (`date_time`)',
        );
        await database.execute(
          'CREATE INDEX `index_sales_created_by` ON `pos` (`created_by`)',
        );
        await database.execute(
  ...
  ProductVariantDao get variantDao {
    return _variantDaoInstance ??= _$ProductVariantDao(
      database,
      changeListener,
    );
  }
  ...
  InventoryMovementDao get movementDao {
    return _movementDaoInstance ??= _$InventoryMovementDao(
      database,
      changeListener,
    );
  }
...
class _$ProductDao extends ProductDao {
  ...
  @override
  Future<void> setActive(String id, int active, String updatedAt) async {
    await _queryAdapter.queryNoReturn(
...
class _$ProductVariantDao extends ProductVariantDao {
  _$ProductVariantDao(this.database, this.changeListener)
    : _queryAdapter = QueryAdapter(database),
  ...
  @override
  Future<void> softDelete(String id, String updatedAt) async {
    await _queryAdapter.queryNoReturn(
...
class _$InventoryMovementDao extends InventoryMovementDao {
  _$InventoryMovementDao(this.database, this.changeListener)
    : _queryAdapter = QueryAdapter(database),
...
class _$SaleDao extends SaleDao {
  ...
  Future<List<Sale>> getAllSales() async {
    return _queryAdapter.queryList(
      'SELECT * FROM pos ORDER BY date_time DESC',
  ...
  Future<Sale?> findSaleById(String id) async {
    return _queryAdapter.query(
      'SELECT * FROM pos WHERE sale_id = ?1',
      mapper: (Map<String, Object?> row) => Sale(
        saleId: row['sale_id'] as String,
        dateTime: row['date_time'] as String,
        customerId: row['customer_id'] as String?,
  ...
  Future<void> clearSales() async {
    await _queryAdapter.queryNoReturn('DELETE FROM pos');
  }
...
class _$SaleLineDao extends SaleLineDao {
  _$SaleLineDao(this.database, this.changeListener)
    : _queryAdapter = QueryAdapter(database),
